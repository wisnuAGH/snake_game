...
def game_over():
    ...
    canvas.create_text(canvas.winfo_width()/2, canvas.winfo_height()/2,
                       font=('ds-digital', 70), text="GAME OVER", fill="red", tag="gameover")
    R = Button(window, text="Play again", font=('ds-digital', 50), width=10, bg="gray",
               fg="green", activeforeground="green")
    canvas.create_window(600, 700,  window=R)

    B = Button(window, text="settings", font=('ds-digital', 30), width=10, bg="gray", fg="black")
    canvas.create_window(1000, 700,  window=B)
